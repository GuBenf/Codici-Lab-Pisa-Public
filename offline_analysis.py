...
if args.i or args.I:
    for file in glob.glob(os.path.join(args.d, "*164304*.h5")):
        ...
        # ANALYZE WITH H5 FILE
        #with analysis.Analysis(raw_data_file=file, cluster_hits=True, tot_calib_file='/home/labb2/tj-monopix2-daq-development/tjmonopix2/scans/output_data/module_0/chip_0/20241212_162859_calibrate_tot_interpreted.h5') as a:
        with analysis.Analysis(raw_data_file=file, cluster_hits=True) as a:
            a.analyze_data()
